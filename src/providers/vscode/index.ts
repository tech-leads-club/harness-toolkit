...
import { renderVSCodeLessonsView } from "./vscode.lessons-view.ts";
import { vscodeRender } from "./vscode.outbound.ts";
import { vscodePolicyDefaults } from "./vscode.policy-defaults.ts";
import { vscodeWiring, vscodeWiringTargets } from "./vscode.wiring.ts";
...
export const vscodeProvider: ProviderPort = {
  ...
  render: vscodeRender,
  wiring: vscodeWiring,
  wiringTargets: vscodeWiringTargets,
  lessonsView: renderVSCodeLessonsView,
};
