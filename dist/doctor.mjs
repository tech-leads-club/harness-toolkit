...
import { existsSync as existsSync28, lstatSync as lstatSync2, readFileSync as readFileSync30, readlinkSync } from "node:fs";
...
// bin/tlc-exec.mjs
import { existsSync as existsSync25, mkdirSync as mkdirSync16, readFileSync as readFileSync27, realpathSync as realpathSync2, writeFileSync as writeFileSync15 } from "node:fs";
...
import { existsSync as existsSync27, mkdirSync as mkdirSync18, readFileSync as readFileSync29, writeFileSync as writeFileSync17 } from "node:fs";

// src/providers/claude/claude.wiring.ts
import { existsSync as existsSync26, mkdirSync as mkdirSync17, readFileSync as readFileSync28, realpathSync as realpathSync3, writeFileSync as writeFileSync16 } from "node:fs";
...
function isCursorWired(targetPath) {
  return existsSync27(targetPath) && readFileSync29(targetPath, "utf8").includes(CURSOR_MARKER);
}
if (false) {}
...
function wiringProblems(wiring) {
  ...
  const text = existsSync28(wiring.target) ? readFileSync30(wiring.target, "utf8") : null;
...
function providerWiringStatus(wiring) {
  ...
  const existingText = existsSync28(wiring.target) ? readFileSync30(wiring.target, "utf8") : null;
